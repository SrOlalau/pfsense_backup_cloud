...
PFSENSE_PORT="1234"  # Replace with your pfSense web interface port
...
BACKUP_ROOT_DIR="/your/local/path/to/save/backups"  # Root directory for backups
...
# Paths for rclone
SRC_PATH="${BACKUP_ROOT_DIR}"
DESTINATION="/your/remote/path/"
